...
public class ProductType {
    ...
    private ProductPriceType productPrice;
    @XmlElement(name = "ProductCategoryMember")
    private ProductCategoryMemberType productCategoryMember;
    @XmlElement(name = "ProductSelectableFeature")
    private ProductSelectableFeatureType productSelectableFeature;
    @XmlElement(name = "ProductDescriptiveFeature")
    private ProductDescriptiveFeatureType productDescriptiveFeature;
    @XmlElement(name = "ProductImage")
    private ProductImageType productImage;
